...
public class AddingDefaultHolidays {
    public static void main(String[] args) {
        ...
        holidays.add(15); // Martin Luther King Jr. Day (third Monday in January)
        holidays.add(22); // Washington's Birthday (third Monday in February)
        holidays.add(1); // Labor Day (first Monday in September)
        holidays.add(8); // Columbus Day (second Monday in October)
        holidays.add(11); // Veterans Day
        holidays.add(22); // Thanksgiving Day (fourth Thursday in November)
